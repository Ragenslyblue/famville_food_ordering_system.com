                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php echo $BASE_URL;?>index_admin.php?page=save_manage_tables" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tables_capacity" class="form-control"/>
                                        </div>
                                        <div class="form-group">
                                            <label>No of Seats:</label>
                                            <input type="text" name="number_of_seats" class="form-control"/>
                                        </div>
