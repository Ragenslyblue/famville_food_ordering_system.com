...
">Export Excel</button>
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="<?php echo $BASE_URL;?>index_admin.php?page=update_ending_inventory" class="btn btn-primary">Update</a></td>
                                            <td class="center"><a href="<?php echo $BASE_URL;?>index_admin.php?page=view_ending_inventory" class="btn btn-primary">View</a></td>
                                        </tr>
                                    <?php
                                        //}
                                    }
