...
<div id="page-wrapper">
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-12">
                    <!-- Form Elements -->
                    <form action="<?php echo $BASE_URL;?>index_cashier_personnel.php?page=pay_for_items_2" method="post" enctype="multipart/form-data">
                    <div class="panel panel-default">
                        ...
                        ?>
                        <input type="hidden" name="table_number_id3[]" value="<?php echo $table_number_id7; ?>" />
                            <div class="row">
                                <div class="col-md-6">
                                    <!--<h3>Basic Form Examples</h3>-->
                                        ...
                                        <input type="hidden" name="billed_amount" value="<?php echo $billed_amount; ?>" />
...
<div id="page-wrap">
                    <table class="table table-bordered table-responsive">
                        ...
                        <input type="hidden" name="order_bill_out_id[]" value="<?php echo $order_bill_out_id; ?>" />
                                <tr>
                                    <td class="text-center"><strong>Guest ID <?php echo $guest_num_id; ?></strong></td>
...
">-->
                                    ...
                                    <!--<a href="cashier_personnel/pay_for_items_2.php" class="btn btn-primary btn-lg"  data-target="#myModal">Pay for Items</a>-->
                                    <!--<a href="<?php //echo $BASE_URL;?>index_cashier_personnel.php?page=leave_table" class="btn btn-primary btn-lg" data-target="#myModal">Leave Table</a>
    ...
    display:  flex;
">
                                    <a href="<?php //echo $BASE_URL;?>index_cashier_personnel.php?page=pay_for_items" class="btn btn-primary btn-lg"  data-target="#myModal">Pay for Items</a>
...
<div style="text-align: center;margin-left: -210px;">Totals: <?php echo $totals; ?></div>
...
">Actions:</h3>
    ...
    margin-right: 100px;
">
                            <button type="submit" name="btnAdd_to_order" value="Pay" class="btn btn-danger btn-lg">Pay</button>
                            <button type="submit" onclick="print_content('page-wrap')" class="btn btn-danger btn-lg">Clear Table</button>
                            <!--<a href="<?php //echo $BASE_URL;?>index_cashier_personnel.php?page=pay_for_items_2" class="btn btn-danger btn-lg">Pay</a>-->
