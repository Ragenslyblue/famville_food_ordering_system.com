...
<div id="page-wrapper">
            <div id="page-inner">
               ...
               <div class="row">
                <div class="col-md-12">
                    <!-- Form Elements -->
                    <form action="<?php echo $BASE_URL;?>index_mobile_app.php?page=review_orders" method="post" enctype="multipart/form-data">
    ...
    margin-left: 35px;
">                                          
                                            <a href="<?php echo $BASE_URL;?>index_mobile_app.php?page=menu_list" class="btn btn-primary btn-lg">Back</a>
                                            <button type="submit" name="btn_place_order" value="Place Order" class="btn btn-primary btn-lg">Place Order</button>
                                          </div>
